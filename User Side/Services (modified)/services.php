...
?>
    ...
    <div class="sub-headercontainer">
        <div class="sub-header">
            <h1>SERVICES</h1>
            <p class="breadcrumbs">
                <a href="../Home/index.php">Home</a> &gt; <span><a href="../Services/services.php">Services</a></span>
            </p>
        </div>
    </div>
    ...
    <div class="container">
        <div class="card">
            ...
            <a href="../Services (modified)/permit.php"><h2>Permit Applications</h2></a>
        ...
        <div class="card">
            ...
            <a href="../Services (modified)/healthservice.php"><h2>Health Appointments</h2></a>
        ...
        <div class="card">
            ...
            <a href="../Services (modified)/taxservice.php"><h2>Tax Clearance Requests</h2></a>
