...
if ($_SERVER["REQUEST_METHOD"] === "POST") {
    ...
    try {
        ...
        $mail->isHTML(true);
        $mail->Subject = 'Your Tax Clearance Request is being Processed';
        $mail->Body = "Hello <strong>$name</strong>,<br><br>
                Thank you for submitting your tax clearance request. It is currently being reviewed.<br>
...
<head>
    ...
    <link rel="stylesheet" href="../Services (modified)/taxservice.css" />
...
?>
    ...
    <!--TAX FORM-->
    <form id="taxForm" method="POST" action="" class="permit-form">
  ...
  <?php endif; ?>
    ...
    <script src="../Services (modified)/taxservice.js" defer></script>
